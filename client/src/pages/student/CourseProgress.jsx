...
const CourseProgress = () => {
  ...
  // Debug video URLs
  console.log('Current lecture video URL:', currentLecture?.videoUrl);
  console.log('Initial lecture video URL:', initialLecture?.videoUrl);
        ...
        <div className="flex-1 md:w-3/5 h-fit rounded-lg shadow-lg p-4">
          <div>
            {currentLecture?.videoUrl || initialLecture?.videoUrl ? (
              <video
                src={formatVideoUrl(currentLecture?.videoUrl || initialLecture?.videoUrl)}
                controls
                ...
                onError={(e) => {
                  ...
                  console.error('Video URL:', formatVideoUrl(currentLecture?.videoUrl || initialLecture?.videoUrl));
